...
public class PasswordResetConfigurer extends AbstractCasWebflowConfigurer {
    ...
    public PasswordResetConfigurer(FlowBuilderServices flowBuilderServices, FlowDefinitionRegistry loginFlowDefinitionRegistry) {
    ...
    private void configurePasswordReset() {
        ...
        createEndState(pswdFlow, CasWebflowConstants.STATE_ID_PASSWORD_UPDATE_SUCCESS, CasWebflowConstants.VIEW_ID_PASSWORD_UPDATE_SUCCESS);
